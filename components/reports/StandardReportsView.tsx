...
const StandardReportsView: React.FC = () => {
    ...
    }, [displayedData, attendanceData, turnoverFilters, attendanceFilters, retentionTimePeriod, cardColor, selectedImpactSkill, att_filteredAttendance, att_relevantEmployees, filteredLeavers]);
